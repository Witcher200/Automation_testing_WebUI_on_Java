...
public class lesson2 {
	public static void main(String[] args) {
        ...
        /*Кейс №1 Регистрайия
            WebElement registration = driver.findElement(By.xpath("//div[@class=\"main-wrapper\"]/div/div/noindex/div/div/div[3]/a"));
            registration.click();
            Thread.sleep(180);
			...
			/*
			* С этим e-mail "igor.h8k@gmail.com" я регистрировался на GeekBrains
			* */
			...
			WebElement input = driver.findElement(By.xpath("//div[@class=\"main-wrapper\"]/div/div/noindex/div/div/div[2]/a"));
			input.click();
			Thread.sleep(100);
...
//Работает
			...
			WebElement button_add1 = driver.findElement(By.xpath("//div[@class=\"main-wrapper\"]/div/div/div/div/div/div[4]/a"));
			button_add1.click();
			Thread.sleep(130);

			WebElement developments = driver.findElement(By.xpath("//div[@class=\"main-wrapper\"]/div/div/div/div/div/div[4]/div/ul/li/a"));
			developments.click();
			Thread.sleep(130);
...
//Работает
			WebElement button_add2 = driver.findElement(By.xpath("//div[@class=\"main-wrapper\"]/div/div/div/div/div/div[4]/a"));
			button_add2.click();
			Thread.sleep(130);

			WebElement vacancies = driver.findElement(By.xpath("//div[@class=\"main-wrapper\"]/div/div/div/div/div/div[4]/div/ul/li[2]/a"));
			vacancies.click();
			Thread.sleep(130);
            ...
            /*WebElement events = driver.findElement(By.xpath("//div[@class=\"main-wrapper\"]/div[2]/div/div/div[3]/a[2]"));
            events.click();
            Thread.sleep(5000);
...
//Работает
			WebElement special_project = driver.findElement(By.xpath("//div[@class=\"main-wrapper\"]/div[2]/div/div/div[3]/a[5]"));
			special_project.click();
			Thread.sleep(130);

			WebElement project = driver.findElement(By.xpath("//div[@class=\"main-wrapper\"]/div[5]/div[5]/a[3]"));
			project.click();
			Thread.sleep(130);
